        ...
        public dynamic GetExchangeConfig()
        {
            try
            {
                ...
                if (!firstBanks.ExchangeStatus.HasValue||(firstBanks.ExchangeStatus.HasValue&& !firstBanks.ExchangeStatus.Value))
                {
                    ...
                    {
                        ResponseCode = -100089,
                        Message = "Hệ thống rút bank đang bảo trì",
                    };
                }
        ...
        public dynamic CreateOrders([FromBody] dynamic input)
        {
            try
            {
                ...
                if (lngGameAmount <= 0)
                {
                    ...
                    {
                        ResponseCode = -1005,
                        Message = "Giá trị tiền rút không hợp lệ",
                    };
                }
                ...
                if (String.IsNullOrEmpty(BankAccount))
                {
                    ...
                    {
                        ResponseCode = -1005,
                        Message = "Chưa nhập số tài khoản",
                    };
                }
                ...
                if (String.IsNullOrEmpty(BankAccountName))
                {
                    ...
                    {
                        ResponseCode = -1005,
                        Message = "Chưa nhập chủ tài khoản",
                    };
                }
                ...
                if(lngGameAmount<min|| lngGameAmount> max)
                {
                    ...
                    {
                        ResponseCode = -1005,
                        Message = "Số tiền rút quá giới hạn cho phép",
                    };
                }
               ...
               // kiểm tra đủ điều kiện giao dịch
                ...
                USDTDAO.Instance.UserBankRequestCreate(RequestType, accountId, lngGameAmount , 0, AmountVNDReceived, PENDING_STAUTS, PartnerID
                ...
                if (Response == 1)
                {
                    ...
                    {
                        ResponseCode = 1,
                        Message = "Chúng tôi đã nhận được yêu cầu.Xin chờ admin phê duyệt"
                    };
                }
                else
                {
