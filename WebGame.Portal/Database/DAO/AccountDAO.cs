...
namespace MsWebGame.Portal.Database.DAO
{
    public class AccountDAO
    {
            ...
            out long Top1InBank, out long Top1InMomo, out long Top1InCard, out DateTime DateTop1InBank, out DateTime DateTop1InMomo, out DateTime DateTop1InCard)
        {
            ...
            Top1InMomo = 0;
            Top1InCard = 0;
            DateTop1InBank = DateTime.Now;
            DateTop1InMomo = DateTime.Now;
            DateTop1InCard = DateTime.Now;
            ...
            try
            {
                ...
                pars[6] = new SqlParameter("@_Top1InBank", SqlDbType.BigInt) { Direction = ParameterDirection.Output };
                pars[7] = new SqlParameter("@_Top1InMomo", SqlDbType.BigInt) { Direction = ParameterDirection.Output };
                pars[8] = new SqlParameter("@_Top1InCard", SqlDbType.BigInt) { Direction = ParameterDirection.Output };
                pars[9] = new SqlParameter("@_DateTop1InBank", SqlDbType.DateTime) { Direction = ParameterDirection.Output };
                pars[10] = new SqlParameter("@_DateTop1InMomo", SqlDbType.DateTime) { Direction = ParameterDirection.Output };
                pars[11] = new SqlParameter("@_DateTop1InCard", SqlDbType.DateTime) { Direction = ParameterDirection.Output };
                ...
                Top1InBank = ConvertUtil.ToLong(pars[6].Value);
                Top1InMomo = ConvertUtil.ToLong(pars[7].Value);
                Top1InCard = ConvertUtil.ToLong(pars[8].Value);
                DateTop1InBank = ConvertUtil.ToDateTime(pars[9].Value);
                DateTop1InMomo = ConvertUtil.ToDateTime(pars[10].Value);
                DateTop1InCard = ConvertUtil.ToDateTime(pars[11].Value);
                return 1;
            }
            catch (Exception ex)
            {
        ...
        public int GetAccount_Profit_SUM(long accountId, out long TotalBetValue, out long TotalPrizeValue)
        {
            DBHelper db = null;
            ...
            try
            {
                ...
                pars[1] = new SqlParameter("@_TotalBetValue", SqlDbType.BigInt) { Direction = ParameterDirection.Output };
                pars[2] = new SqlParameter("@_TotalPrizeValue", SqlDbType.BigInt) { Direction = ParameterDirection.Output };
                

                db.ExecuteNonQuerySP("SP_AccountGame_Profit_SUM", pars);
                TotalBetValue = ConvertUtil.ToLong(pars[1].Value);
                TotalPrizeValue = ConvertUtil.ToLong(pars[2].Value);
