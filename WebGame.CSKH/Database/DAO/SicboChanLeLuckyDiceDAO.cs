...
{
    public class SicboChanLeLuckyDiceDAO
    {
        private static readonly Lazy<SicboChanLeLuckyDiceDAO> _instance = new Lazy<SicboChanLeLuckyDiceDAO>(() => new SicboChanLeLuckyDiceDAO());

        public static SicboChanLeLuckyDiceDAO Instance
        {
        ...
        public List<SicboChanLeRefunds> GetRefundsInfo(long uid, long session)
        {
            DBHelper db = null;
            try
            {
                ...
                var list = db.GetListSP<SicboChanLeRefunds>("SP_GetRefundsInfo", pars);
                return list;
            }
            catch (Exception ex)
            {
