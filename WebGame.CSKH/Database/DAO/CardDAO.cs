...
namespace MsWebGame.CSKH.Database.DAO
{
    public class CardDAO
    {
        ...
        public RecivedAvengeCallBackModel UserCardSwapCallBack(string TransactionCode)
        {
           
            DBHelper db = null;
            try
            {
                db = new DBHelper(Config.GameCardLogConn);
                SqlParameter[] param = new SqlParameter[1];
                param[0] = new SqlParameter("@_TransactionCode", TransactionCode);
                var _obj = db.GetInstanceSP<RecivedAvengeCallBackModel>("SP_CardCallBack_GetByID", param.ToArray());
                var bodySend = Newtonsoft.Json.JsonConvert.SerializeObject(_obj);
                return _obj;
        ...
        public int UserCardSwapExamine(long examineUserId, long userCardSwapId, long userId, int status, out long balance, string CardNumberSend, string CardSerialSend, long? CardValue)
        {
            DBHelper db = null;
            try
            {
                ...
                pars[4] = new SqlParameter("@_ServiceID", 1);
                pars[5] = new SqlParameter("@_RemainBalance", SqlDbType.BigInt) { Direction = ParameterDirection.Output };
                pars[6] = new SqlParameter("@_Response", SqlDbType.Int) { Direction = ParameterDirection.Output };
                pars[7] = new SqlParameter("@_CardNumber_Send", CardNumberSend);
                pars[8] = new SqlParameter("@_CardSerial_Send", CardSerialSend);
                pars[9] = new SqlParameter("@_CardValue_Send", CardValue);
                db.ExecuteNonQuerySP("SP_UserCardSwap_Examine", pars);
                balance = ConvertUtil.ToLong(pars[5].Value);
        ...
        public List<TopUpReport> GetTopUpReport(DateTime? fromDate, DateTime? toDate, int serviceid)
        {
            ...
            try
            {
                ...
                pars[5] = new SqlParameter("@_BankSum", SqlDbType.BigInt);
                pars[5].Direction = ParameterDirection.Output;
                pars[6] = new SqlParameter("@_MomoOutSum", SqlDbType.BigInt);
                pars[6].Direction = ParameterDirection.Output;
                pars[7] = new SqlParameter("@_BankOutSum", SqlDbType.BigInt);
                ...
                long bank = Convert.ToInt32(pars[5].Value);
                long momoout = Convert.ToInt32(pars[6].Value);
                long bankout = Convert.ToInt32(pars[7].Value);
