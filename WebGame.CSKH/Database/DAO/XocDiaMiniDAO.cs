...
{
    public class XocDiaMiniDAO
    {
        private static readonly Lazy<XocDiaMiniDAO> _instance = new Lazy<XocDiaMiniDAO>(() => new XocDiaMiniDAO());

        public static XocDiaMiniDAO Instance
        {
        ...
        public List<XocDiaMiniRefunds> GetRefundsInfo(long uid, long session)
        {
            DBHelper db = null;
            try
            {
                ...
                var list = db.GetListSP<XocDiaMiniRefunds>("SP_GetRefundsInfo", pars);
                return list;
            }
            catch (Exception ex)
            {
