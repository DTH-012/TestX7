...
{
    public class Md5LuckyDiceDAO
    {
        private static readonly Lazy<Md5LuckyDiceDAO> _instance = new Lazy<Md5LuckyDiceDAO>(() => new Md5LuckyDiceDAO());

        public static Md5LuckyDiceDAO Instance
        {
        ...
        public List<EventModel> GetEventList()
        {
            ...
            try
            {
                db = new DBHelper(Config.Md5LuckyDiceConn);
        ...
        public List<Md5Refunds> GetRefundsInfo(long uid, long session)
        {
            DBHelper db = null;
            try
            {
                ...
                var list = db.GetListSP<Md5Refunds>("SP_GetRefundsInfo", pars);
                return list;
            }
            catch (Exception ex)
            {
