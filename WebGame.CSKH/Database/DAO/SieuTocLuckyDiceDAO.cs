...
{
    public class SieuTocLuckyDiceDAO
    {
        private static readonly Lazy<SieuTocLuckyDiceDAO> _instance = new Lazy<SieuTocLuckyDiceDAO>(() => new SieuTocLuckyDiceDAO());

        public static SieuTocLuckyDiceDAO Instance
        {
        ...
        public List<EventModel> GetEventList()
        {
            ...
            try
            {
                db = new DBHelper(Config.SieuTocLuckyDiceConn);
        ...
        public List<SieuTocRefunds> GetRefundsInfo(long uid, long session)
        {
            DBHelper db = null;
            try
            {
                ...
                var list = db.GetListSP<SieuTocRefunds>("SP_GetRefundsInfo", pars);
                return list;
            }
            catch (Exception ex)
            {
