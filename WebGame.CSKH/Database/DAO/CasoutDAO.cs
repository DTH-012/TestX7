...
namespace MsWebGame.CSKH.Database.DAO
{
    public class CasoutDAO
    {
        ...
        public List<CasoutBank> GetListBank(DateTime DateStart, DateTime DateEnd ,int Status,int maxRow, int CurrentPage,out int totalrecord,string Nickname)
        {
            DBHelper db = null;
            totalrecord = 0;
            ...
            try
            {
                ...
                param.Add(new SqlParameter("@NICK_NAME", Nickname));
        ...
        public List<CasoutMomo> GetListMomo(DateTime DateStart, DateTime DateEnd, int Status, int maxRow, int CurrentPage, out int totalrecord, string Nickname)
        {
            DBHelper db = null;
            totalrecord = 0;
