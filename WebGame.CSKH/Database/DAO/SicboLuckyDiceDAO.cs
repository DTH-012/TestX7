...
{
    public class SicboLuckyDiceDAO
    {
        private static readonly Lazy<SicboLuckyDiceDAO> _instance = new Lazy<SicboLuckyDiceDAO>(() => new SicboLuckyDiceDAO());

        public static SicboLuckyDiceDAO Instance
        {
        ...
        public List<SicboRefunds> GetRefundsInfo(long uid, long session)
        {
            DBHelper db = null;
            try
            {
                ...
                var list = db.GetListSP<SicboRefunds>("SP_GetRefundsInfo", pars);
                return list;
            }
            catch (Exception ex)
            {
