...
{
    public class XocDiaVipDAO
    {
        private static readonly Lazy<XocDiaVipDAO> _instance = new Lazy<XocDiaVipDAO>(() => new XocDiaVipDAO());

        public static XocDiaVipDAO Instance
        {
        ...
        public List<XocDiaVipRefunds> GetRefundsInfo(long uid, long session)
        {
            DBHelper db = null;
            try
            {
                ...
                var list = db.GetListSP<XocDiaVipRefunds>("SP_GetRefundsInfo", pars);
                return list;
            }
            catch (Exception ex)
            {
