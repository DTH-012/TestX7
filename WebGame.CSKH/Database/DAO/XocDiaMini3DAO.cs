...
{
    public class XocDiaMini3DAO
    {
        private static readonly Lazy<XocDiaMini3DAO> _instance = new Lazy<XocDiaMini3DAO>(() => new XocDiaMini3DAO());

        public static XocDiaMini3DAO Instance
        {
        ...
        public List<XocDiaMini3Refunds> GetRefundsInfo(long uid, long session)
        {
            DBHelper db = null;
            try
            {
                ...
                var list = db.GetListSP<XocDiaMini3Refunds>("SP_GetRefundsInfo", pars);
                return list;
            }
            catch (Exception ex)
            {
