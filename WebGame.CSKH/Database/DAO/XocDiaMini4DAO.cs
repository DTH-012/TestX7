...
{
    public class XocDiaMini4DAO
    {
        private static readonly Lazy<XocDiaMini4DAO> _instance = new Lazy<XocDiaMini4DAO>(() => new XocDiaMini4DAO());

        public static XocDiaMini4DAO Instance
        {
        ...
        public List<XocDiaMini4Refunds> GetRefundsInfo(long uid, long session)
        {
            DBHelper db = null;
            try
            {
                ...
                var list = db.GetListSP<XocDiaMini4Refunds>("SP_GetRefundsInfo", pars);
                return list;
            }
            catch (Exception ex)
            {
