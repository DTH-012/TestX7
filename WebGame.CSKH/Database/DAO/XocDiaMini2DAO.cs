...
{
    public class XocDiaMini2DAO
    {
        private static readonly Lazy<XocDiaMini2DAO> _instance = new Lazy<XocDiaMini2DAO>(() => new XocDiaMini2DAO());

        public static XocDiaMini2DAO Instance
        {
        ...
        public List<XocDiaMini2Refunds> GetRefundsInfo(long uid, long session)
        {
            DBHelper db = null;
            try
            {
                ...
                var list = db.GetListSP<XocDiaMini2Refunds>("SP_GetRefundsInfo", pars);
                return list;
            }
            catch (Exception ex)
            {
