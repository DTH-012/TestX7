    ...
    public class USDTController : BaseController
    {
        ...
        private List<SelectListItem> GetStatus()
        {
            return new List<SelectListItem>()
            {
                ...
                new SelectListItem() {Text="Admin hủy rút ",Value="4" },
