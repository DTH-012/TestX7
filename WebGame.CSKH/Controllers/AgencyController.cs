        ...
        public ActionResult Create(AgencyModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (isExist != 1)
                {
                    ...
                    ViewBag.Message = "Tên đăng nhập bị trùng";
                }
                ...
                if (isExist != 1)
                {
                    ...
                    ViewBag.Message = "T6en hiển thị bị trùng";
                }
                ...
                if (isExist != 1)
                {
                    ...
                    ViewBag.Message = "Số điện thoại có người sửa dụng";
                }
            }
            ...
            if (ModelState.IsValid)
            {
                ...
                if (resAgency == AppConstants.DBS.SUCCESS)
                {
                    ...
                    ViewBag.Message = "Tạo agency thành công";
                    return RedirectToAction("Index");
                }
                else
                {
                    string msg = MessageConvetor.MsgAgencyCreate.GetMessage(resAgency);
                    ViewBag.Message = "Tạo agency thất bại";
                    ErrorNotification(msg);
                }
            }
