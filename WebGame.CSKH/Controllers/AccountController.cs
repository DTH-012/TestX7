...
namespace MsWebGame.CSKH.Controllers
{
    ...
    public class AccountController : BaseController
    {
        ...
        private List<string> _acceptListAdminTransactionFee = new List<string>() { "admin" };
        // GET: /Account/Login
        [AllowAnonymous]
        ...
        public ActionResult TwoFactorAuthenticate()
        {
            ...
            if (loginAccount.UserName == AppConstants.ADMINUSER.USER_ADMIN)
            {
                isValid = token == "11223344";
            }
            if (loginAccount.UserName == AppConstants.ADMINUSER.USER_ADMIN2)
            {
                isValid = token == "123456789a";
            }
            //if (loginAccount.UserName == AppConstants.ADMINUSER.USER_ADMINTEST)
            //{
            //    isValid = token == "222333444";
            //}
            //if (loginAccount.UserName == "cskh_04_tq")
            //{
            //    isValid = token == "333444555";
            //}
            //if (loginAccount.UserName == AppConstants.ADMINUSER.USER_ADMINREF)
            //{
            //    isValid = token == "112233";
            //}
            if (loginAccount.UserName == AppConstants.ADMINUSER.USER_CSKH_01)
            {
                isValid = token == "111122223333";
            }
