...
(function () {
    ...
    GlobalHeader.CasoutSubmitStatus = function (Id, UserId, BankCode, status) {

        $.ajax({
            type: "POST",
            url: GlobalHeader.Config.Root_Url + "Casout/UpdateStatus",
    ...
    GlobalHeader.CasoutMomoSubmitStatus = function (Id, UserId, status) {

        $.ajax({
            type: "POST",
            url: GlobalHeader.Config.Root_Url + "Casout/UpdateStatusMomo",
            xhrFields: { withCredentials: true },
            crossDomain: true,
            data: {
                Id: Id,
