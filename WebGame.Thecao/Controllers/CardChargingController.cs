...
namespace MsWebGame.Thecao.Controllers
{
    ...
    public class CardChargingController : BaseApiController
    {
        ...
        //    var msgs = (String.Format("{0}|{1}", "01", ErrorMsg.ParamaterInvalid));
        //    return StringResult(msgs);
        //    try
        //    {
        ...
        //                CardRefDAO.Instance.UpdateCardChardRefStatus(lngRequestID, card.UserID, errorCode, message, STATUS_SMG_NOT_REFUND, PARTNER_ONE, value, minValue, receiveValue, out outResponse);
        //                if (outResponse == 1)
        //                {
        //                    try
        //                    {
        ...
        //            {
        //                SendChargingHub(card.UserID, 0, "Nạp thẻ thất bại", 0, ServiceID);
        //                CardRefDAO.Instance.UpdateCardChardRefStatus(lngRequestID, card.UserID, errorCode, message, -1, PARTNER_ONE, value, null, null, out outResponse);
        //                if (outResponse == 1)
        //                {
        ...
        //            CardRefDAO.Instance.UpdateCardChardRefStatus(lngRequestID, card.UserID, errorCode.ToString(), message, 1, PARTNER_ONE, value, null, null, out outResponse);
        //            if (outResponse == 1)
        //            {
        ...
        //                    outResponse = 0;
        //                    CardDAO.Instance.UpdateCardChardStatus(lngRequestID, card.UserID, errorCode, message, 2, PARTNER_ONE, out outResponse);
